...
const Home = () => {
  ...
  useEffect(() => {
    // Start timer for visual section when user enters Visual1
    const sectionStartTime = Date.now();
    localStorage.setItem("visualSectionStartTime", sectionStartTime.toString());
    localStorage.setItem("visualCurrentStartTime", sectionStartTime.toString());
    localStorage.setItem("chosenSection", "visual");
    console.log("Visual section timer started at:", sectionStartTime);
